CREATE TABLE `admin_user` (
  `user_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '管理员用户id',
  ...
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8mb4 COMMENT='管理员用户表';
...
CREATE TABLE `admin_role` (
  ...
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='管理员角色表角色';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='管理员用户角色关联表';
